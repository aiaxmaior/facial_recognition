...
Outputs:
- 8 emotions (Ekman extended): angry, contempt, disgust, fear, happy, sad, surprise, neutral
- Derived Valence/Arousal estimates from emotion distributions

The emotions are used to derive pain/pleasure indicators:
- Pain indicators: sad, fear, angry, disgust, contempt
...
# Using 8-category Ekman extended model (includes contempt)
EMOTION_VALENCE = {
    'angry': -0.6,
    'contempt': -0.4,  # Mild negative - superiority/dismissiveness
    'disgust': -0.7,
    'fear': -0.8,
    'happy': 0.9,
    'sad': -0.7,
...
EMOTION_AROUSAL = {
    'angry': 0.8,
    'contempt': 0.4,  # Low-moderate arousal - controlled expression
    'disgust': 0.5,
    'fear': 0.9,
    'happy': 0.7,
    'sad': 0.3,
